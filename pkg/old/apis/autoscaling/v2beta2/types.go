...
type HorizontalPodAutoscaler struct {
	...
	// +optional
	Spec HorizontalPodAutoscalerSpec `json:"spec" protobuf:"bytes,2,opt,name=spec"`

	// status is the current information about the autoscaler.
	// +optional
	Status HorizontalPodAutoscalerStatus `json:"status" protobuf:"bytes,3,opt,name=status"`
}
